...
from app.api.v1.endpoints import auth, stories, chapters, payment, ai, admin, recommendations, publish, notifications
...
api_router.include_router(payment.router, prefix="/payments", tags=["F2 - VNPAY Payment (Frontend Alias)"])
...
api_router.include_router(chapters.author_router, prefix="/author/chapters",
