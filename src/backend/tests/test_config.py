...
def production_config(**overrides):
    config = {
        ...
        "VNP_TMN_CODE": "PRODTMN",
        "VNP_HASH_SECRET": "prod-vnp-hash-secret",
        "VNP_URL": "https://pay.vnpay.vn/paymentv2/vpcpay.html",
        "VNP_RETURN_URL": "https://yag.example.com/payment/result",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"VNP_HASH_SECRET": "YAGDEVSECRETKEY12345678"}, "VNP_HASH_SECRET"),
        ({"VNP_TMN_CODE": "YAGTEST1"}, "VNP_TMN_CODE"),
        ...
        (
            ...
            "VNP_RETURN_URL must not point",
        ),
        (
            {"VNP_RETURN_URL": "http://yag.example.com/payment/result"},
            "VNP_RETURN_URL must be HTTPS",
        ),
        (
