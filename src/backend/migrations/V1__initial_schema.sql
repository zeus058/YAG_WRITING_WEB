...
CREATE TABLE IF NOT EXISTS chapters (
    ...
    CONSTRAINT chk_chapters_moderation_status   CHECK (moderation_status IN ('draft', 'pending', 'approved', 'rejected', 'flagged'))
);
...
-- -----------------------------------------------------------------------------
-- 14. admin_alerts — Admin dashboard alerts generated by moderation/scheduler
-- -----------------------------------------------------------------------------
...
COMMENT ON TABLE admin_alerts IS 'Admin dashboard alerts for missed schedules and moderation issues';


-- -----------------------------------------------------------------------------
-- 15. admin_audit_logs — Audit trail for admin actions
-- -----------------------------------------------------------------------------
...
COMMENT ON TABLE admin_audit_logs IS 'Immutable audit trail for admin moderation and account actions';
...
-- chapters: allow explicit draft status for author autosave before publishing
