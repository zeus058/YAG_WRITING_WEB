  ...
  return (
    <span className={`brand-mark-container ${className}`} style={{ display: "inline-flex", alignItems: "center", gap: "10px" }} aria-label="YAG">
      ...
      >
        ...
        {/* Left branch */}
        <line x1="22" y1="22" x2="50" y2="50" stroke="currentColor" strokeWidth="9" strokeLinecap="round" opacity="0.38" />
        {/* Right branch */}
        <line x1="78" y1="22" x2="50" y2="50" stroke="currentColor" strokeWidth="9" strokeLinecap="round" opacity="0.38" />
        {/* Stem */}
      ...
      <span className="yag-wordmark" style={{ display: "inline-flex", alignItems: "baseline", gap: "2px", fontWeight: 300, fontSize: "20px", letterSpacing: "2.5px" }}>
