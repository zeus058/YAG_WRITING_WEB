...
### 1. Proposal (Đề xuất dự án)
  Template Document: [Proposal](https://docs.google.com/document/d/1lpCL9G6OxMRG_48cPEBg9ESrjq9BBzsx/edit?usp=sharing&ouid=116947766377760701705&rtpof=true&sd=true)
  ...
  #### Mô tả dự án/Tóm tắt vấn đề: https://hackmd.io/@rindx/writingweb

  #### Mô tả chức năng phần mềm: https://hackmd.io/@rindx/UserStory
  ...
  #### Phân chia nguồn lực và Chi phí:
    null

  #### Công cụ sử dụng:
    Nộp bài: Moddle Khoa CNTT - HCMUS.
    Phân chia công việc: JIRA.
    Lưu trữ mã nguồn, tài liệu, báo cáo: GitHub.
    Liên hệ: Meeting (chủ yếu), Diễn đàn môn học (chung),  Email(riêng).
