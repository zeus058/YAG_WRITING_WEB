...
Web Application (Giao diện người dùng hợp nhất): Đây là nơi người dùng trực tiếp tương tác với hệ thống. Tầng này không chứa logic xử lý phức tạp mà chỉ nhận lệnh và hiển thị kết quả. Tùy vào vai trò và thao tác, ứng dụng sẽ chuyển đổi giữa các không gian làm việc khác nhau:
