...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/login", destination: "/auth?tab=login", permanent: true },
      { source: "/register", destination: "/auth?tab=register", permanent: true },
      ...
      { source: "/forgot-password", destination: "/auth/recovery", permanent: true },
